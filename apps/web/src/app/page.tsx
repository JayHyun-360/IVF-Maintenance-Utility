      ...
      >
        ...
        <header
          ...
          style={{
            ...
            backgroundPosition: themeConfig.backgroundImage
              ? "center center"
              : "auto",
            backgroundRepeat: themeConfig.backgroundImage
              ? "no-repeat"
              : "auto",
            ...
            transition:
              "background-image 1.5s cubic-bezier(0.4, 0, 0.2, 1), background 1.5s cubic-bezier(0.4, 0, 0.2, 1), background-color 1.5s cubic-bezier(0.4, 0, 0.2, 1)",
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            <MobileCardGrid columns={2} className="mb-4">
