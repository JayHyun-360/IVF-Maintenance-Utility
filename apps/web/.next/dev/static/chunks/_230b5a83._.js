...
const themes = {
    ...
    dark: {
        ...
        backgroundImage: "https://images.unsplash.com/photo-1519681393784-d120267933ba?w=1920&h=1080&fit=crop&crop=bottom"
    }
};
...
const applyTheme = (theme, skipAnimations = false)=>{
    ...
    const easing = prefersReducedMotion ? "linear" : "cubic-bezier(0.4, 0, 0.2, 1)";
    ...
    headerElements.forEach((header)=>{
        ...
        if (!prefersReducedMotion) {
            setTimeout(()=>{
                ...
                if (theme === "standard") {
                    htmlHeader.style.filter = "brightness(1.02) saturate(1.05) contrast(1.02)";
                    addNatureParticles(header);
                } else if (theme === "light") {
                    htmlHeader.style.filter = "brightness(1.01) saturate(1.02) contrast(1.01)";
                    addOceanShimmer(header);
                } else if (theme === "dark") {
                    htmlHeader.style.filter = "brightness(0.98) contrast(1.02) saturate(1.1)";
        ...
        if (!prefersReducedMotion) {
            setTimeout(()=>{
                ...
                setTimeout(()=>{
                    ...
                    htmlImg.style.filter = "brightness(1) saturate(1) contrast(1) hue-rotate(0deg)";
                }, baseDuration * 500);
...
const addNatureParticles = (header)=>{
...
const addStarfieldSparkle = (header)=>{
...
const removeThemeEffects = (header)=>{
...
const addEnhancedHoverEffects = (element, theme)=>{
    // Add theme-specific hover effects
...
//# sourceMappingURL=_230b5a83._.js.map